...
1. CLAUDE.md を読み、質問リストを順番に投げる
2. 回答を `user-comment.md` に追記する
3. 最後に「明日からのアクション3つ」を抽出して末尾にまとめる

<br>

**これが今日の裏テーマ**: *ハンズオン自体が Claude Code の生きたデモになる*
